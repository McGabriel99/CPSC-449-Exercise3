...
enrollment_service_1: uvicorn --port 5100 project1.api.__main__:app --reload
enrollment_service_2: uvicorn --port 5101 project1.api.__main__:app --reload
enrollment_service_3: uvicorn --port 5102 project1.api.__main__:app --reload
